...
public class Relatorio {
	...
	public static void rubyOnRails() {
		
		System.out.println("\n\n-//-//-//-//- RUBY ON RAILS -//-//-//-//-");
		System.out.println("Também conhecido como Rails, é um framework de desenvolvimento web escrito em Ruby por David Heinemeier Hansson em 2005.");
		System.out.println("Ele introduziu muitas convenções e padrões que simplificaram o desenvolvimento web ágil e eficiente.");
	...
	public static void php() {
		...
		System.out.println("\n\n-//-//-//-//- PHP -//-//-//-//-");
		System.out.println("Criada por Rasmus Lerdorf em 1994, o PHP (Hypertext Preprocessor) é uma linguagem de script amplamente usada para o desenvolvimento");
		System.out.println("e aplicativos web dinâmicos na criação de sites interativos e na popularização da web dinâmica. ");
	}
	
	public static void cSharp() {
		
		System.out.println("\n\n-//-//-//-//- C# -//-//-//-//-");
		System.out.println("Criada pela Microsoft em 2000, a linguagem C# foi projetada para ser a linguagem de programação ");
		System.out.println("principal para o desenvolvimento de aplicativos para a plataforma Windows. Ela é amplamente usada em desenvolvimento de software empresarial e jogos.");
	...
	public static void cPlusPlus() {
		...
		System.out.println("\n\n-//-//-//-//- C++ -//-//-//-//-");
		System.out.println("Desenvolvida por Bjarne Stroustrup nos anos 80, a linguagem C++ é uma extensão da linguagem C que introduziu recursos de programação orientada a objetos");
		System.out.println("Ela se tornou essencial para o desenvolvimento de software de sistemas, jogos e aplicativos de alto desempenho.");
	}
	
	public static void c() {
		
		System.out.println("\n\n-//-//-//-//- C -//-//-//-//-");
		System.out.println("A linguagem C, criada por Dennis Ritchie nos laboratórios Bell da AT&T em 1972, é uma das linguagens mais influentes na história da computação.");
		System.out.println("Famosa por sua eficiência e portabilidade, ela serviu como base para o desenvolvimento de muitas outras linguagens e sistemas operacionais.");
